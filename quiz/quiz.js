...
const quizzes = [
  ...
  { id: 'ferrari', title: 'Ferrari F1 Drivers', sub: 'Name every Ferrari driver since 2000.', href: '/ferrari/', tag: 'QUIZ 5', topic: 'f1', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#DC0000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></svg>' },
  { id: 'europe', title: 'Countries of Europe', sub: 'Can you name all 46 countries of Europe?', href: '/europe/', tag: 'QUIZ 6', topic: 'travel', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>' },
